...
public class UserController {
	...
	//processing add contact Handler form
	...
	public String processContact(@ModelAttribute Contact contact,
		...
		try {
			...
			//message Success....ka bejh na hai
			session.setAttribute("message", new Message("Your contact is added !! Add more...", "success"));
		}catch(Exception e) {
			System.out.println("Error: "+e.getMessage());
			e.printStackTrace();
			//error message....bejh na hai 
	...
	public String showContacts(@PathVariable("page") Integer page ,Model m, Principal principal ) {
		...
		//contact ki list ke bhejni hai
		
		String userName = principal.getName();
		User user = this.userRepository.getUserByUserName(userName);
		//current-page Page
		//Contact Per Page - 5
		Pageable pePageable = PageRequest.of(page, 10);
		
		Page<Contact> contacts = this.contactRepository.findContactsByUser(user.getId(), pePageable);
	...
	public String showContactDetails(@PathVariable("cId") Integer cId, Model model, Principal principal) {
		...
		//check userid and contactId match warna error
		String userName = principal.getName();
		User user = this.userRepository.getUserByUserName(userName);
...
//creating order for payment
		...
		public String createOrder(@RequestBody Map<String, Object> data, Principal principal ) throws Exception {
			...
			RazorpayClient client=new RazorpayClient("rzp_test_NI1F6j1fSf1vgO", "CiwKKNUdFauhvCQskXSYbFh2");
